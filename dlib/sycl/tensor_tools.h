    ...
    class tensor_rand
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                ...
                when dlib is compiled with DLIB_USE_SYCL.  So you should not write code
...
// ----------------------------------------------------------------------------------------
        ...
        /*!
            requires
                - All the devices have stopped writing to the tensors given to set().  So
                  you should probably call syclDeviceSynchronize() on each of the relevant
    ...
    private:
        std::vector<std::unique_ptr<::dlib::sycl::enable_peer_access>> epa;
